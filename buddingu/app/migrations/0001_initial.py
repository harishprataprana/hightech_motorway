# Generated by Django 4.1.11 on 2024-02-18 18:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description_one', models.TextField(blank=True, max_length=1000, null=True)),
                ('description_two', models.TextField(blank=True, max_length=1000, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Categories',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('certificate', models.CharField(default='No', max_length=100, null=True)),
                ('slug', models.SlugField(blank=True, default='', max_length=500, null=True)),
                ('status', models.TextField(choices=[('PUBLISH', 'PUBLISH'), ('DRAFT', 'DRAFT')], max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aud', models.FloatField(default=None, max_length=300)),
                ('cad', models.FloatField(default=None, max_length=300)),
                ('inr', models.FloatField(default=None, max_length=300)),
                ('gbp', models.FloatField(default=None, max_length=300)),
                ('usd', models.FloatField(default=None, max_length=300)),
            ],
        ),
        migrations.CreateModel(
            name='Video',
